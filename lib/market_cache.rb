...
module TradingLogic
  class MarketCache
    ...
    def refresh_market_cache(force: false, batch_size: 200) # rubocop:disable Metrics/AbcSize,Metrics/CyclomaticComplexity,Metrics/PerceivedComplexity
      ...
      out = items.map do |i|
        ...
        { 'ticker' => i[:ticker], 'figi' => i[:figi], 'lot' => i[:lot], 'price' => price,
