...
# rakefile_spec грузит Rakefile, а тот делает `require 'dotenv/load'` — то есть
# настоящий .env разработчика протекает во ВЕСЬ прогон и может незаметно включить
...
# minimal stub of Tinkoff protobuf constants for tests
unless defined?(Tinkoff)
  module Tinkoff
    module Public
      module Invest
        module Api
